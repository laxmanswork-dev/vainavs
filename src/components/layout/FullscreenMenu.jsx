    ...
    <AnimatePresence>
      {open && (
        <motion.div
          ...
          animate="visible"
          exit="hidden"
          className="bg-atmosphere fixed inset-0 z-40 flex flex-col overflow-hidden pt-[4.5rem] backdrop-blur-md"
        ...
        >
          ...
          <div className="relative flex flex-1 flex-col justify-center">
            {/* Editorial grid — a left "brand detail" column and a right
                ...
                anchored and stable. */}
            <Container className="grid -translate-y-6 grid-cols-1 items-center gap-10 sm:-translate-y-8 lg:-translate-y-10 lg:grid-cols-12 lg:gap-8">
