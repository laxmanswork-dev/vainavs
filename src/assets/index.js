...
// ---------------------------------------------------------------- Logo ----
export { default as logo } from './images/logo/logo.webp'
...
// --------------------------------------------------------- Categories ----
export { default as categoryCoffee } from './images/categories/coffee.webp'
export { default as categoryBurger } from './images/categories/burger.webp'
export { default as categoryWraps } from './images/categories/wraps.webp'
export { default as categoryNoodles } from './images/categories/noodles.webp'
export { default as categoryDrinks } from './images/categories/drinks.webp'
export { default as categoryDesserts } from './images/categories/desserts.webp'
...
export { default as heritageKan } from './images/heritage/kan.webp'
export { default as heritageStory } from './images/heritage/story.webp'
...
export { default as heritageTable } from './images/heritage/cafe.webp'
...
export { default as heritageBackground } from './images/heritage/new.webp'
...
export { default as ourStoryAtmosphere } from './images/our-story/add.webp'
...
export { default as ourStoryBackground } from './images/our-story/background.webp'
...
export { default as ourStoryMoment } from './images/our-story/moment.webp'
...
export { default as menuChickenWrap } from './images/signature-menu/chicken-wrap.webp'
export { default as menuSizzlingBrownie } from './images/signature-menu/sizzling-brownie.webp'
export { default as menuRoyalFalooda } from './images/signature-menu/royal-falooda.webp'
export { default as menuMonsterShake } from './images/signature-menu/monster-shake.webp'
export { default as menuLoadedBurger } from './images/signature-menu/loaded-burger.webp'
export { default as menuChickenPopcorn } from './images/signature-menu/chicken-popcorn.webp'
...
// placeholder for now, same convention as every other asset here.
export { default as signatureMenuBackground } from './images/signature-menu/ground.webp'
...
export { default as menuChickenWrapCheese } from './images/menu/chicken-wrap-cheese.webp'
export { default as menuPrawnLollipop4 } from './images/menu/prawn-lollipop-4.webp'
export { default as menuPrawnLollipop5 } from './images/menu/prawn-lollipop-5.webp'
export { default as menuPopcornMedium } from './images/menu/popcorn-medium.webp'
export { default as menuPopcornLarge } from './images/menu/popcorn-large.webp'
export { default as menuVegBurger } from './images/menu/veg-burger.webp'
export { default as menuChickenBurger } from './images/menu/chicken-burger.webp'
export { default as menuBreadOmelette } from './images/menu/bread-omelette.webp'
export { default as menuVegSandwich } from './images/menu/veg-sandwich.webp'
export { default as menuChickenSandwich } from './images/menu/chicken-sandwich.webp'
export { default as menuCheeseSandwich } from './images/menu/cheese-sandwich.webp'
export { default as menuCheeseChickenSandwich } from './images/menu/cheese-chicken-sandwich.webp'
export { default as menuFriesSmall } from './images/menu/fries-small.webp'
export { default as menuFriesMedium } from './images/menu/fries-medium.webp'
export { default as menuFriesLarge } from './images/menu/fries-large.webp'
export { default as menuCheeseFries } from './images/menu/cheese-fries.webp'
export { default as menuLoadedFries } from './images/menu/loaded-fries.webp'
export { default as menuMaggiNormal } from './images/menu/maggi-normal.webp'
export { default as menuMaggiVeg } from './images/menu/maggi-veg.webp'
export { default as menuMaggiPaneer } from './images/menu/maggi-paneer.webp'
export { default as menuShakeBanana } from './images/menu/shake-banana.webp'
export { default as menuShakeStrawberry } from './images/menu/shake-strawberry.webp'
export { default as menuShakeChocolate } from './images/menu/shake-chocolate.webp'
export { default as menuShakeVanilla } from './images/menu/shake-vanilla.webp'
export { default as menuShakeButterscotch } from './images/menu/shake-butterscotch.webp'
export { default as menuShakeMango } from './images/menu/shake-mango.webp'
export { default as menuShakeOreo } from './images/menu/shake-oreo.webp'
export { default as menuShake5Star } from './images/menu/shake-5star.webp'
export { default as menuShakeBlueberry } from './images/menu/shake-blueberry.webp'
export { default as menuShakeTenderCoconut } from './images/menu/shake-tender-coconut.webp'
export { default as menuShakeDryFruit } from './images/menu/shake-dry-fruit.webp'
export { default as menuSmoothieStrawberry } from './images/menu/smoothie-strawberry.webp'
export { default as menuSmoothieMango } from './images/menu/smoothie-mango.webp'
export { default as menuSmoothieBlueberry } from './images/menu/smoothie-blueberry.webp'
export { default as menuDessertMexicanBrownie } from './images/menu/dessert-mexican-brownie.webp'
export { default as menuDessertDeadByChocolate } from './images/menu/dessert-dead-by-chocolate.webp'
export { default as menuDessertMississippiMud } from './images/menu/dessert-mississippi-mud.webp'
...
// asset here.
export { default as menuShowcaseBackground } from './images/menu/add.webp'
...
export { default as contactVisitBackground } from './images/contact/lam.webp'
